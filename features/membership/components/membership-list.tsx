...
import { MembershipDeleteButton } from "./membership-delete-btn";
    ...
    <Table>
      ...
      <TableBody>
        {memberships.map((membership) => {
          const membershipMoreMenu = <MembershipMoreMenu 
          userId={membership.userId} 
          organizationId={membership.organizationId}
          membershipRole={membership.membershipRole}
          />;
          
          const deleteMembership = <MembershipDeleteButton organizationId={membership.organizationId} userId={membership.userId} />;
